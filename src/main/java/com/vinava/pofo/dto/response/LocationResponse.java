...
public class LocationResponse {
    ...
    private static List<LocationResponse> from(List<Location> locations) {
        List<LocationResponse> locationResponses = new LinkedList<>();
        for (Location location : locations) {
            locationResponses.add(from(location));
        }
        return locationResponses;
    }

    public static ResponseEntity<List<LocationResponse>> getResponseEntityFrom(List<Location> locations) {
        try {
            List<LocationResponse> locationResponses = from(locations);
